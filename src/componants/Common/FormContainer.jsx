        ...
        <div className="--right">
          ...
          <div className="Forms">
            ...
            <div className="--form" style={{ flexWrap: "wrap" }}>
              {arrayValuesResp.length > 0 && (
                <Saved array={arrayValuesResp} setArray={setArrayResp} />
              )}
              {arrayValuesCetrification.length > 0 && (
                <Saved
          ...
          <div className="signUpFooter">
            ...
            <div className="--flexCenter">
              <span className="badge bg-primary-subtle hand text-primary  ">
                Privacy Policy
              </span>
              <span
                onClick={() => {
                ...
                className="badge bg-primary-subtle  hand text-primary  "
              >
