...
const Home = ({ setModell }) => {
  ...
  const { useGetRequest } = api;

  const { data , isPending } = api.useGetRequest({
    enabled: true,
    PATH: "fetchAll/jobs/10/0",
    key: ["get-jobs"],
    initialData: [],
  });
              ...
              <div className={home.cardMain}>
                <div className={home.cards}>
                  <p className={home.cardHeader}>
                    Unlock Your Potential: Find Your Dream with our job portal
                    Today!
                  </p>
                ...
                <div className={home.cards}>
                  <p className={home.cardHeader}>
                    Your Gateway to Success: Explore Endless Career
                    Possibilities!
                  </p>
                  <p className={home.cardPara}>
                    - Invite users to explore a diverse range of job listings
                    and take the first step towards achieving their professional
                    goals.
                  </p>
                  <div className={home.cardFooter}>
                    <a href="#">
            ...
            <div className={home.header2}>
              <div className={home.contentLeft2}>
                ...
                <p className={home.openings}>
                  ...
                  you! We are thrilled to announce a plethora of new job
                  openings across diverse industries and roles, all curated to
                  match your unique skills and aspirations.
                </p>
              </div>
              <div className={home.contentRight2}>
                <button
                  onClick={handleNavigateToJobs}
                  className={`hand ${home.button}`}
                >
                  See all jobs
