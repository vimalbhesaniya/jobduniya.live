    ...
    <div className="card container  w-100 bg-body-secondary cardContainer">
      ...
      <div className="row mb-3">
        <div className="col-md-12">
          ...
          <input
            type="text"
            placeholder="responsibilitie-must be comma(,) separated"
            className="form-control"
      ...
      <div className="row mb-3">
        <div className="col-md-12">
          ...
          <input
            type="text"
            placeholder="achievements-must be comma(,) separated"
            className="form-control"
            name="achievements"
      ...
      <button
        type="submit"
        value="Submit"
        className="btn btn-info w-25 mb-3sign"
